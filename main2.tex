...
% think about forecasting on social media

% Advertisers can curate their ads to be more effective.  The combination of the correct size, content, and interesting form of advertising will increase its effectiveness for generating clicks, and greater awareness \cite{Imsa2020}.  The use of corporate brand names influences firm profits \cite{Swani2021}.  Brand names allow the advertisement to depict emotional traits like quality, value, credibility, personalities, and identities \cite{Swani2021}. The location of the advertisement is essential too. Advertisements whose location is above the page receive more fixation but not more recognition  \cite{Authors2013}.  The content has a significant effect on ad credibility \cite{Huang2020}.  Advertisers who develop their brand, use it in their advertisements generate more user engagement.

%Advertisers can increase their advertising effectiveness through the use of corporate names in branding campaigns \cite{Swani2021}.  A large goal of advertisers is related to branding.  Stronger corporate brands reduce the perceived service risks for consumers \cite{Swani2021}.  Using corporate brand names enhances self-identity, which in turn increases the likelihood users will like the message \cite{Swani2021}.  Using corporate brand names instead of no brand name has been shown to influence firm profits \cite{Swani2021}.

% Exposure frequency increases an ad's effectiveness \cite{Huang2020}.  A greater number of exposures to an ad elicits better cognitive responses and makes the ad more memorable and likable \cite{Huang2020}. In addition, advertising repetition has a linear positive effect on recall \cite{Huang2020}. Therefore, advertisers can increase their campaign effectiveness through repeated ad exposure.

% Relationships with users generate more conversions for advertisers \cite{Archak2010}.  The idea of relationship marketing focuses on building mutually satisfying long-term relationships with key users to grow their business \cite{Archak2010}.  There is a correlation between ad impressions and user conversion \cite{Archak2010}. Users who make queries regarding the brand indicate a growing user-advertiser relationship \cite{Archak2010}.  When advertisers build longer-term relationships with users, they improve their business outcomes.

% Advertisers want to build consumer relationships.  Brands can build brand awareness through advertisement engagements, which leads to better brand awareness, loyalty, and relationships \cite{Swani2021}.  Purchase intentions increase through positive experiences that build positive thoughts, experiential pleasure, and ad credibility.  Brands are finding that creating interactive and targeting marketing are the keys to success, even that traditional advertising is a waste of money \cite{Wright2010}.  By winning consumer attention, advertisers build their brands on social media \cite{Voorveld2018}.  Brands are now following these holistic marketing concepts that focus on consumer relationship marketing \cite{Wright2010}.  

% Brands want to communicate with users, influence their actions, and build relationships \cite{Swani2021, Saez-Trumper2014, Wright2010, Voorveld2018}.  Customer brand interactions impact individual-level outcomes in terms of customer spending, purchase intentions, brand trust, loyalty, and customer brand engagement \cite{Swani2021}.  The interactions also affect firm-level outcomes like sales, return on investment, and stock prices \cite{Swani2021}.  By building mutually satisfying relationships, brands earn and retain their business \cite{Wright2010}.  These brands use social media channels to communicate with users.  Self-media platforms offer people the chance to manage their own communications channels, such as Twitter, that allow platform collaboration and questions between brands and users.  Advertising according to the platform's character provides creative outlets where platforms share content and interact with user interests \cite{Voorveld2018}.  Brands use social media platforms to build user relationships and influence business outcomes.  
